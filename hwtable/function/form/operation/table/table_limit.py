...
from function.form.operation.menu.menu_limit import MenuLimitOperations

class TableLimitWidget(QWidget):
    ...
    @staticmethod
    def create_table_limit_widget():
        return TableLimitWidget()

from PySide6.QtWidgets import QMainWindow, QVBoxLayout, QWidget, QTableWidget, QTableWidgetItem, QApplication, QMenu
...
class MergeOperations:
    ...
    def unmerge_cells(self):
        ...
        for selected_range in selected_ranges:
            ...
            merged_item = self.table.item(top_row, left_col)  # 获取左上角单元格
            ...
            font = merged_item.font() if merged_item else self.table.font()  # 获取合并单元格的字体
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.merge_operations = MergeOperations(self.table)
        ...
        self.setWindowTitle("Merge and Unmerge Cells Test")
    ...
    def open_menu(self, position):
        ...
        merge_action.triggered.connect(self.merge_operations.merge_cells)
        unmerge_action.triggered.connect(self.merge_operations.unmerge_cells)
